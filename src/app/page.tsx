...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    let smoother = ScrollSmoother.create({
      ...
      smooth: 1.2, // How long the scroll takes to catch up
      effects: true, // Enables data-speed and data-lag attributes
      normalizeScroll: true, // Prevents unwanted browser scroll behaviors
    });
    ...
    // Fade-in animations for Mission and Innovation text/image
  ...
  return (
    <div id="smooth-wrapper">
      <div id="smooth-content" className="bg-slate-950 text-slate-50 font-sans relative overflow-hidden">
        {/* Hero Section */}
        ...
        {/* Mission Statement */}
        <section className="container mx-auto px-4 my-24 md:my-36 mission-section">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/2">
              <Image
                ...
                width={1000}
                height={600}
                data-speed="0.9" // ScrollSmoother parallax effect
        ...
        <section className="container mx-auto px-4 my-24 md:my-36 innovation-section">
